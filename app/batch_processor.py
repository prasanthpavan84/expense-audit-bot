...
class BatchProcessor:
    ...
    async def process_record_with_retry(
        self, record: dict[str, Any], audit_func: Callable[[dict[str, Any]], Any]
    ) -> dict[str, Any]:
    ...
    async def process_csv_stream(
        self, csv_filepath: str, audit_func: Callable[[dict[str, Any]], Any], chunk_size: int = 100
    ...
    async def process_json_list_stream(
        self, json_filepath: str, audit_func: Callable[[dict[str, Any]], Any], chunk_size: int = 100
    ) -> AsyncGenerator[dict[str, Any], None]:
        """
