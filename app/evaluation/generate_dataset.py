...
def generate_dataset():
    ...
    for i in range(1, 101):
        ...
        if i % 3 == 0:
            ...
            text = "Golden Casino check-in. Date: 2026-06-25. Total: USD 75.00."
            expected_status = "Rejected"
            expected_category = "Other"
            expected_amount = 75.00
        elif i % 3 == 1:
            # Fake merchant keyword
            text = "Dummy Store transaction. Date: 2026-06-25. Total: USD 45.00."
            expected_status = "Rejected"
            expected_category = "Other"
            expected_amount = 45.00
        else:
            # Weekend claim
            text = "McDonalds Meals. Date: 2026-06-21. Total: USD 35.00."  # June 21, 2026 is Sunday
    ...
    for i in range(1, 51):
        ...
        text = "Blurry receipt printout. Starbucks. Date: 2026-06-25. Total: USD 15.00."
    ...
    for i in range(1, 51):
        ...
        if i % 3 == 0:
            text = "Taxi ride in Paris. Date: 2026-06-25. Total: EUR 30.00."
            expected_currency = "EUR"
            expected_amount = 30.00
            expected_status = "Approved"
        elif i % 3 == 1:
            text = "Meals in London. Date: 2026-06-25. Total: GBP 45.00."
            expected_currency = "GBP"
            expected_amount = 45.00
            # 45 GBP = 58.5 USD which is > $50 limit, so should be rejected/partial
            expected_status = "Rejected"
        else:
            text = "Taxi ride in Delhi. Date: 2026-06-25. Total: INR 150.00."
    ...
    for i in range(1, 51):
        ...
        if i % 2 == 0:
            text = "Refund adjustment. Date: 2026-06-25. Total: USD -15.00."
            expected_status = "Rejected"  # Negative amounts rejected by validation
            expected_amount = -15.00
        else:
            text = "Flight to Tokyo. Date: 2026-06-25. Total: USD 9999.00."
