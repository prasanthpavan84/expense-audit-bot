...
_KNOWN_MERCHANTS = [
    "uber", "lyft", "taxi", "hilton", "marriott", "starbucks",
    "mcdonalds", "burger king", "pizza hut", "subway", "delta",
    "united airlines", "american airlines", "southwest",
    "amazon", "walmart", "office depot", "staples",
]
...
class NLU:
    ...
    def extract_entities(text: str) -> NLUResult:
        ...
        found = sum(1 for k in ["amount", "currency", "date", "merchant",
                                 "category", "department", "employee_id",
                                 "policy_reference"] if k in entities)
    ...
    def classify_missing_fields(
        nlu_result: NLUResult, workflow_intent: str
    ) -> NLUResult:
        ...
        nlu_result.missing_critical = [
            f for f in critical if f not in nlu_result.entities
        ]
        nlu_result.missing_optional = [
            f for f in OPTIONAL_FIELDS if f not in nlu_result.entities
        ]
        return nlu_result
    ...
    def _extract_category(text: str) -> Optional[str]:
        ...
        categories = {
            "meal": "Meals", "food": "Meals", "lunch": "Meals",
            "dinner": "Meals", "breakfast": "Meals",
            "hotel": "Hotel", "stay": "Hotel", "accommodation": "Hotel",
            "flight": "Travel", "travel": "Travel", "taxi": "Travel",
            "uber": "Travel", "transport": "Travel", "cab": "Travel",
        ...
        merchant_cats = {
            ...
            "uber": "Travel", "lyft": "Travel", "taxi": "Travel",
            "starbucks": "Meals", "mcdonalds": "Meals", "burger king": "Meals", "pizza hut": "Meals", "subway": "Meals",
            "delta": "Travel", "united": "Travel", "american": "Travel", "southwest": "Travel",
        }
    ...
    @staticmethod
    def _extract_policy_reference(text: str) -> Optional[str]:
        """Extract policy-related references from text."""
        policy_keywords = [
            "meal limit", "hotel limit", "travel limit", "spending limit",
            "reimbursement policy", "travel policy", "expense policy",
            "company policy", "policy", "limit", "rules", "allowed",
        ]
    ...
    @staticmethod
    def _extract_user_role(text: str) -> Optional[str]:
