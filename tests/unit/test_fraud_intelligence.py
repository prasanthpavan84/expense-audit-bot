...
def test_impossible_travel():
    ...
    exp = {"merchant": "Taxi in Paris", "raw_text": "Taxi ride in Paris", "amount": 25.00, "currency": "USD", "date": "2026-06-25"}
    history = [
        {"merchant": "Starbucks in New York", "raw_text": "Starbucks in New York", "amount": 5.50, "currency": "USD", "date": "2026-06-25"}
    ]
