...
from app.models.state import AuditResult, ExpenseItem, WorkflowState
...
class TestAIIntelligence(unittest.TestCase):
    ...
    def test_orchestrator_integration(self):
        ...
        self.assertEqual(
            state.metadata.get("response"), "Hello! I am your Expense Audit assistant. How can I help you today?"
        )
